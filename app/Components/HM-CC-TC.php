        ...
        return '<div class="hh">'
            . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
                ...
                . '<div class="pull-right">'
                    ...
                    . '<span class="info" data-id="' . ($component['TEMPERATURE']+4) . '" data-component="' . $component['component'] . '" data-datapoint="SETPOINT" style="color:#808080"></span>'
                    . '<span class="info" data-id="' . $component['TEMPERATURE'] . '" data-component="' . $component['component'] . '" data-datapoint="TEMPERATURE" style="font-weight: bold"></span>'
